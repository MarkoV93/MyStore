            ...
            <div class="col-sm-12 col-md-12 col-lg-12 ">
                ...
                <div class="col-sm-2 col-md-2 col-lg-2">
                    ...
                    <form action="${requestScope.path}" method="get">
                        <select class="form-control col-sm-6 col-md-6 col-lg-6" name="cityCriteria"   size="1">
                        ...
                        <button type="submit" onclick="handler()" class="btn btn-primary">Filter</button>
